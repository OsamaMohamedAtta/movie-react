...
const Movie = () => {
    ...
    useEffect(() => {
        const getMediaData = async () => {
            await getMedia('movie', 1, setMovieData, setError, setLoading)
        }
        getMediaData()
    }, [])
    ...
    const handlePageClick = async (pageNumber) => {
        ...
        await getMedia('movie', currentPage, setMovieData, setError, setLoading)
    }
                            ...
                            <div className="col-lg-2 col-md-3 col-sm-12" key={data.id}>
                                <div className="section-info">
                                    <div className="img-poster">
                                        ...
                                        <Link to={`/details/${data.id}/movie`} className="poster-layer media d-flex justify-content-center align-items-center">
                                            show more details
                                        </Link>
                                    </div>
